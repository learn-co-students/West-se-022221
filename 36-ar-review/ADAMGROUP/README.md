Stuff and things from Adam's group review...
...
only the "belongs_to" side has the foreign key


      vet -----< appt >----- pet >----- owner

Appointments appointment should have 
  cost(float), 
  belong_to a Veterinarian(integer) 
  and belong_to a Pet(integer)
