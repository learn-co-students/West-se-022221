# Auth with Rails + React

#### SWBATs
- [x] Login with Username & Plain Password
- [x] Plain Text Passwords in DB
- [x] Hashing vs encryption
- [x] Authentication vs Authorization
- [x] Authentication + Authorization = `Auth`
- [x] Sign up Flow
- [x] Login Flow
- [x] JWT
- [x] How/Where to store `token` while using React front end?
